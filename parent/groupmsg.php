...
$query_recInbox = "SELECT * FROM groupmsg WHERE `to` in (select standard from student where parent_username='$username') and division in(select division from student where parent_username='$username')";
