...
if(isset($_POST['btn1']))
{
	 ...
	 $result=mysqli_query("select password from parent where username='".$_POST['txtuser']."' and e_mail='".$_POST['txtemail']."'",$PTS);
...
<form id="form1" name="form1" method="post" action="">
  <table width="339" border="0" align="center">
    ...
    <tr>
      ...
      <td><input type="submit" name="btn1" id="btn1" value="Send Code" class="btn btn-primary"/></td>
    </tr>
    <tr>
...
var txtemail = new Spry.Widget.ValidationTextField("txtemail", "email");
</script>
</div>	
				</div>
