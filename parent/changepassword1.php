...
$totalRows_recchangepass = mysqli_num_rows($recchangepass);
	...
	{
  $updateSQL = sprintf("UPDATE parent SET  password=%s WHERE username=%s",
  ...
  <table width="354" border="0" align="center">
    <tr>
      ...
      <td width="166"><span id="sprypassword1">
        ...
        <input type="password" name="txtpass1" id="txtpass2" class="from-control"/>
    ...
    <tr>
      ...
      <td><span id="sprypassword2">
        ...
        <input type="password" name="txtpass2" id="txtpass3" class="from-control"/>
      <span class="passwordRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr>
      ...
      <td><span id="spryconfirm1">
        ...
        <input type="password" name="txtpass3" id="txtpass4" class="from-control"/>
