					...
					<div class="col-md-offset-3 col-md-6">
						<div class="title">
							<div class="wow bounceIn">
								<h2 class="section-heading animated" data-animation="bounceInUp">STUDENTS</h2>
							</div>
                          </div>
                        </div>
...
<thead style="background-color:#036;color:#fff">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="attendanceupload.php?regno=<?php echo $row_recSTD['reg_no']; ?>">Add Attandace</a></td>
        <td><a href="attendance.php?regno=<?php echo $row_recSTD['reg_no']; ?>">View Attanadance</td>
         <td><a href="scoresheet.php?regno=<?php echo $row_recSTD['reg_no']; ?>&std=<?php echo $row_recSTD['standard']; ?>">Score</a></td>
      </tr>
      <?php } while ($row_recSTD = mysqli_fetch_assoc($recSTD)); ?>
  </table>
  <p>&nbsp;
  <table border="0">
    <tr>
